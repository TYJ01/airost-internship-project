...
def cvt2env(cubestate):
    ...
    corner_comb = [['B','O','W'],['B','R','W'],['G','O','W'],['G','R','W'],['B','R','Y'],['B','O','Y'],['G','R','Y'],['G','O','Y']]
    color_index = [[6,38,9],[8,18,11],[45,44,15],[47,24,17],[2,20,27],[0,36,29],[53,26,33],[51,42,35]]
    ...
    if cubestate[5][1][1] == 'G':
        cube[5][1][1] = 49
    cube100 =[cubestate[0][2][0],cubestate[1][0][0], cubestate[4][0][2]]
    ...
    edge_comb = [['B','Y'],['B','R'],['B','W'],['B','O'],['O','W'],['O','Y'],['R','Y'],['R','W'],['G','W'],['G','O'],['G','Y'],['G','R']]
    colore_index = [[1,28],[5,19],[7,10],[3,37],[41,12],[39,32],[23,30],[21,14],[46,16],[48,43],[52,34],[50,25]]
