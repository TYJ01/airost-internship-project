...
def cube_window(cube_face):
    ...
    cv.putText(blank, "if correct, doublepress 's' ", (50, 50), cv.FONT_HERSHEY_COMPLEX,
               0.7, (0, 255, 0), 1)
    cv.putText(blank, "else press 'q' to record again ...", (70, 70),
               cv.FONT_HERSHEY_COMPLEX,
               0.7, (0, 255, 0), 1)
    for i in range(3):
        for j in range(3):
            cv.rectangle(blank, (100 + 100 * i, 100 + 100 * j), (100 + 100 * (i + 1), 100 + 100 * (j + 1)), (0, 255, 0), 2)

    for i in range(3):
        for j in range(3):
            if cube_face[i][j] == "G":
                cv.rectangle(blank, (100 + 100 * j, 100 + 100 * i), (100 + 100 * (j + 1), 100 + 100 * (i + 1)),
                             (0, 255, 0), -1)
            if cube_face[i][j] == "B":
                cv.rectangle(blank, (100 + 100 * j, 100 + 100 * i), (100 + 100 * (j + 1), 100 + 100 * (i + 1)),
                             (255, 0, 0), -1)
